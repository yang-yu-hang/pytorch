...
def do_bench_using_profiling(
    ...
    from torch._inductor.runtime.benchmarking import may_distort_benchmarking_result, lock_gpu

    return lock_gpu(may_distort_benchmarking_result(_do_bench_using_profiling))(
